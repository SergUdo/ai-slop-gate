...
* Assists in technical alignment with **EU AI Act transparency** and **DORA** supply chain security requirements.
...
│   ├── adapters/           # VCS Integrations (GitHub, GitLab)
│   ├── cache/              # Caching Layer
...
│   ├── providers/          # AI Engines (Groq, Gemini, Ollama)
